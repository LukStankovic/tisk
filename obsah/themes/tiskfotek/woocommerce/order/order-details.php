...
?>
<h3 class="block-head"><?php _e( 'Order Details', 'woocommerce' ); ?></h3>
...
*/
				...
				//				do_action( 'woocommerce_order_item_meta_end', $item_id, $item, $order );
							...
							<div class="row">
                              <dl class="variation">
                               <div class="col-md-2">
                                   <img src="<?php echo $item["item_meta"]["Fotky"][0]; ?>">
                               </div>
                                <?php 
                                $pocet = 0;
                                    ...
                                    <?php } ?>      
                                     ...
                                     <?php if ($pocet == 2) {?>    
                                        ...
                                        <?php } ?>
                                            ...
                                            <dt><?php echo $klic; ?>:</dt>
                                              <dd><p><?php echo $jedna_polozka;?></p></dd>
	...
	<?php
		...
		if ( $has_refund ) { ?>
			<tr>
				...
				<td colspan="2">-<?php echo wc_price( $total_refunded, array( 'currency' => $order->get_order_currency() ) ); ?></td>
			</tr>
		<?php
		}
...
<header class="padd-top-30">
	<h3 class="block-head"><?php _e( 'Customer details', 'woocommerce' ); ?></h3>
</header>
...
<?php endif; ?>
        ...
        <h3 class="block-head"><?php _e( 'Billing Address', 'woocommerce' ); ?></h3>
		<address>
			<?php
...
<?php if ( ! wc_ship_to_billing_address_only() && $order->needs_shipping_address() && get_option( 'woocommerce_calc_shipping' ) !== 'no' ) : ?>
	...
	<div class="col-md-6">
	    ...
	    <h3 class="block-head"><?php _e( 'Shipping Address', 'woocommerce' ); ?></h3>
		<address>
			<?php
