...
class ITFramework {
    ...
    public function display_page() {
        ...
        echo '<div class="wrap form-wrapper theme_opts_form">';
                ...
                settings_fields( 'theme_options' );
                echo '<h1 class="block-head">' . __( '<b>EXCEPTION</b> - Theme options','itrays' ) . '<p class="submit">
                <input name="Submit" type="submit" class="button btnb button-primary sub-btn" value="' . __( 'Save Changes','itrays' ) . '" />
                </p></h1>';
                ...
                echo '</div></div></div>';
                echo '<h2 class="block-head bot-foot"><span class="copyrights">IT-RAYS Framework. v 1.4 - All Rights reserved.</span><p class="submit">
                <input name="Submit" type="submit" class="button btnb no-rad mar-rit button-primary" value="' . __( 'Save Changes','itrays' ) . '" /></p></h2>';
                echo '</form>';
    ...
    /*public function export_settings() {
        ...
        $settings = array();
        $settings['theme_options'] = get_option( 'theme_options' );
        
        return it_encode($settings);
