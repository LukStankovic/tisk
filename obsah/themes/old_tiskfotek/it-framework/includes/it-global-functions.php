...
if ( ! function_exists( 'it_eg_category' ) ){
   function it_eg_category() {
        ...
        $GLOBALS[ 'cat_name' ] = $terms[$id]->name;
        $GLOBALS[ 'slug' ] = $terms[$id]->slug;
        $GLOBALS[ 'taxonomy' ] = $terms[$id]->taxonomy;
        echo '<a href="../../'.$GLOBALS[ 'taxonomy' ]. '/' .$GLOBALS['slug']. '">'.$GLOBALS[ 'cat_name' ].'</a>';
    }  
}
...
// Modefied comments numbers for recent posts.
