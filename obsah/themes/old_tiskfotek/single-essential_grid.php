                    ...
                    <?php if ( theme_option('singlepostimg_on') == "1" ) : ?>
                            ...
                            if ( get_post_gallery() ) {
                                ...
                                <?php
                                  ...
                                  ?>
                                  <iframe class="esg-vimeo-frame haslistener esg-vimeovideo readytoplay" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen="" width="100%" height="300" src="http://player.vimeo.com/video/<?php echo esc_url($vimeovideo); ?>?title=0&amp;byline=0&amp;html5=1&amp;portrait=0&amp;api=1&amp;player_id=vimeoiframe65115&amp;api=1" data-src="about:blank"></iframe>
                                  <?php
                            }else if($utvideo){
                                 ?>
                                 <iframe class="esg-youtube-frame haslistener esg-youtubevideo" frameborder="0" wmode="Opaque" width="100%" height="300" src="https://www.youtube.com/embed/<?php echo esc_url($utvideo); ?>?version=3&amp;enablejsapi=1&amp;html5=1&amp;controls=1&amp;autohide=1&amp;rel=0&amp;showinfo=0" data-src="about:blank" id="ytiframe28709"></iframe>
                                 <?php
                            }else if($soundcloud){
                                ?>
                                <iframe width="100%" height="300" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/<?php echo esc_url($soundcloud); ?>&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe>
                                <?php
