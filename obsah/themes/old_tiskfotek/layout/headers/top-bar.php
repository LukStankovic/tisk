                ...
                <div class="left">
                    ...
                    <?php } else if ($top_left == "loginregister") { ?>
                        ...
                        <?php if ( $user_ID ) : ?>
                            ...
                            <li class="login-out"><b><?php echo __('Welcome','itrays') ?></b>, <a href="<?php echo esc_url(get_option('siteurl')); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a> <a href="<?php echo esc_url(wp_logout_url()); ?>" title="<?php echo __('Log out of this account','itrays') ?>"><?php echo __('Log Out','itrays') ?></a></li>
                        <?php else : ?>
                            
                            <?php if (get_option('users_can_register')) : ?>
                                <li><a href="<?php echo esc_url(get_option('siteurl')); ?>/wp-login.php?action=register"><i class="fa fa-user"></i><?php _e('Register','itrays') ?></a></li>
                            <?php endif; ?>
